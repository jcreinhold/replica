...
[replica_rfs_lm, dim_lm] = replica_train_multires_low_memory(atlas_struct, param_struct);
...
replica_predict_multires_low_memory(subject_struct, param_struct, replica_rfs_lm, 'train_dim', dim_lm);
