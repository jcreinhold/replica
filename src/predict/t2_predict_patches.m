function [test_patches, dim, fg] = t2_predict_patches(ss, ps)
%T2_PREDICT_PATCHES extract patches to do regression on w/ RF
% specific to synthesizing T2w images from T1w images
%
%   Args:
